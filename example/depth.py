...
class MPublisher(Node):
    ...
    def __init__(self):
        ...
        while True:
            ...
            dim_gray = cv2.convertScaleAbs(dpt, alpha=0.0425)
            ...
            for box in boxs:
                ...
                dist = get_mid_pos(frame, box, depth_colormap, 128)
                #print(dist/50)
                ...
                # cv2.putText(img,box[-1]+ " dis:"+ str(dist/50)[:4] + 'm',
                            #(int(box[0]), int(box[1])), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
